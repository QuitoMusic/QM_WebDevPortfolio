  ...
  return (
    <div name='home' className='h-screen w-full '>
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row '>
            <div className='mt-[5rem] flex flex-col justify-center items-center h-full'>
            <div className='2xl:w-[350px] md:w-[300px] w-[200px] absolute md:mt-[1rem]'>
             <img src= {Portrait} alt="Portrait" className='rounded-full mx-auto md:mb-[20rem] mb-[25rem] mt-[1rem] md:mt-[3rem]'/>
            </div>
            ...
            <div className="text-center justify-center bg-opacity-80 pt-[5rem] mt-[10rem] md:pt-[8.5rem] 2xl:p-[1rem] 2xl:pt-[9rem] 2xl:pb-[1rem] bg-slate-100 rounded-lg 2xl:mt-[17rem] md:mt-[13rem] 2xl:w-[42rem]">
            <h2 className='text-xl xl:text-xl text-black md:text-yellow-950 pb-2 font-extrabold'>
                    My name is
                </h2>
                <h2 className='text-shadow-lg shadow-yellow-950 text-5xl xl:text-5xl text-yellow-950 font-signature'>
                    Francisco González
                </h2>
                <p className='pb-0 pt-4 text-black font-extrabold md:text-yellow-950 max-w-2xl text-center text-md'>
