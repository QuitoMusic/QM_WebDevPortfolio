  ...
  return (
    <div name='home' className='h-screen w-full '>
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row '>
            <div className='mt-[4rem] flex flex-col justify-center items-center h-full'>
            ...
            <div className="text-center justify-center bg-opacity-80 pt-[6rem] mt-[8rem] md:pt-[8.5rem] 2xl:p-[1rem] 2xl:pt-[9rem] 2xl:pb-[1rem] bg-slate-100 rounded-lg 2xl:mt-[17rem] md:mt-[13rem] 2xl:w-[42rem]">
            <h2 className='text-2xl xl:text-xl text-black md:text-yellow-950 pb-2 font-extrabold'>
                ...
                <p className='pb-2 pt-4 pr-3 pl-3 text-black font-extrabold md:text-yellow-950 max-w-2xl text-center text-md'>
