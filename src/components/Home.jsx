  ...
  return (
    <div name='home' className='h-screen w-full '>
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
            ...
            <div class="text-shadow-lg shadow-yellow-950 text-center justify-center bg-opacity-80 pt-[5rem] mt-[5rem] md:pt-[7rem] 2xl:p-[1rem] 2xl:pt-[9rem] 2xl:pb-[1rem] bg-slate-100 rounded-lg 2xl:mt-[13rem] md:mt-[10rem] 2xl:w-[42rem]">
            <h2 className='text-2xl xl:text-xl text-yellow-950 pb-2 font-extrabold'>
                    My name is
                </h2>
                <h2 className='text-5xl xl:text-5xl text-yellow-950 font-signature'>
                    Francisco González
                </h2>
                <p className='p-4 text-yellow-950 max-w-2xl text-center text-md'>
