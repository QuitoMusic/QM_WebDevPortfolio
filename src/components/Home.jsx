  ...
  return (
    <div name='home' className='h-screen w-full '>
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
            ...
            <div class="text-shadow-lg shadow-yellow-950 text-center justify-center bg-opacity-80 pt-[5rem] mt-[8rem] md:pt-[7rem] 2xl:p-[1rem] 2xl:pt-[9rem] 2xl:pb-[1rem] bg-slate-100 rounded-lg 2xl:mt-[13rem] md:mt-[10rem] 2xl:w-[42rem]">
