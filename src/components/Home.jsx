    ...
    <div name='home' className='h-screen w-full '>
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
            ...
            <div className='2xl:w-[350px] md:w-[300px] w-[200px] absolute'>
             <img src= {Portrait} alt="Portrait" className='rounded-full mx-auto md:mb-[20rem] mb-[25rem] mt-[-2rem]'/>
            </div>
            ...
            <div class="text-center justify-center bg-opacity-80 pt-[5rem] mt-[7rem] md:pt-[7rem] 2xl:p-[1rem] 2xl:pt-[9rem] 2xl:pb-[1rem] bg-slate-100 rounded-lg 2xl:mt-[13rem] md:mt-[10rem] 2xl:w-[42rem]">
            <h2 className='text-2xl xl:text-xl text-black md:text-yellow-950 pb-2 font-extrabold'>
                ...
                <p className='pb-0 pt-4 text-black font-extrabold md:text-yellow-950 max-w-2xl text-center text-lg'>
